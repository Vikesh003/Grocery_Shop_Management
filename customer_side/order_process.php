...
<html>
	...
	<body>
		<div class="container">
			<br />
			<h3 align="center"><a href="#">Payment</a></h3>
			<br />
	    						...
	    						<div class="row">
	    								...
	    								<div class="form-group">
		    								<label><b>Area <span class="text-danger">*</span></b></label>
                                                                                <?php $q=  mysqli_query($con,"select * from area"); ?>
	    							...
	    							<div class="col-sm-6">
	    								<div class="form-group">
		    								<label><b>City <span class="text-danger">*</span></b></label>
                                                                                <input type="text" name="customer_city" id="customer_city" class="form-control" value="Surat" readonly="true" />
			    							<span id="error_customer_city" class="text-danger"></span>
			    						</div>
	    							</div>
	    							<div class="col-sm-6">
	    							...
	    							<div class="col-sm-6">
	    								<div class="form-group">
		    								<label><b>State </b></label>
                                                                                <input type="text" name="customer_state" id="customer_state" class="form-control" value="Gujarat" readonly="true" />
			    						</div>
	    							</div>
	    							<div class="col-sm-6">
	    								<div class="form-group">
		    								<label><b>Country <span class="text-danger">*</span></b></label>
		    								<input type="text" name="customer_country" id="customer_country" class="form-control"  value="India" readonly="true" />
...
Stripe.setPublishableKey('pk_test_wQoGRMBh67of9K5EpWyZE1sT00k6s5HXFY');

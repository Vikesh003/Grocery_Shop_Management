...
$query = "
SELECT dealer_products.*,order_item_customer.* FROM dealer_products,order_item_customer where order_item_customer.order_item_customerid='$id' and order_item_customer.order_item_name=dealer_products.PRODUCT_NAME
";
...
if($statement->execute())
{
	...
	{
            $total=$row['order_item_quantity']*$row["PRODUCT_PRICE"];
		$output .= '

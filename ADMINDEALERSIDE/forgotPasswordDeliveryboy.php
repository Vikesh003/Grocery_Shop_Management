...
if(isset($_POST['submit']))
{
	...
	$password=  md5($_POST['password']);
        ...
        if($num>0)
        {
            ...
            $_SESSION['id']=$num['deliveryboy_id '];
        ...
        {
            $ret=mysqli_query($con,"SELECT * FROM TBL_DEALER WHERE DEALER_EMAIL='$username' and DEALER_PASSWORD='$password'");
            $num=mysqli_fetch_array($ret);
        if($num>0)
        {
            if(!empty($_POST["remember"])) {
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="forgotPasswordDeliveryboy.php">Forgotten Password?</a>
                                    </label>
                                </div>

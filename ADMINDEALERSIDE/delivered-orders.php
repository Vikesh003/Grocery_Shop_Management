                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Delivered's order</strong>
                                    </div>
                                    <div class="row">
                            <div class="col-lg-12">
...
$query=  mysqli_query($con,"SELECT order_table.*,order_item_customer.*,customer_reg.* from order_table,order_item_customer,customer_reg WHERE order_table.order_id=order_item_customer.order_id and order_table.deliveryBoyId='$did'  and order_table.orderStatus='$st'");
$cnt=1;

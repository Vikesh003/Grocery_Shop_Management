...
if(isset($_POST['submit']))
{
	...
	$password=$_POST['password'];
        ...
        $ret=mysqli_query($con,"SELECT * FROM TBL_ADMIN WHERE ADMIN_EMAIL='$username' and (ADMIN_PASSWORD='$password' or ADMIN_PASSWORD='$password1')");
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <?PHP IF($_SESSION['errmsg']!=""){ echo "<h6 style='color:red'>".$_SESSION['errmsg']."</h6>"; } ?>
                            ...
                            <div class="register-link">
                                <p>
                                    Don't you have Dealer account?
                                    <a href="dealer_reg.php">Sign Up Here</a>
                                </p>
                            </div>
                        </div>
                    </div>

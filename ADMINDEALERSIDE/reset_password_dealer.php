   ...
   if(isset($_POST['update']))
{
    ...
    $pass=  mysqli_query($con,"select * from tbl_dealer where DEALER_ID='$id'");
    $c=  mysqli_fetch_array($pass);
    $pa=$c['DEALER_PASSWORD'];
    if($pa==$password or $pa==$password1){
        if($npassword==$rpassword){
                $query=mysqli_query($con,"update tbl_dealer set DEALER_PASSWORD='$npassword' WHERE DEALER_ID='$id'");
                if($query){
                                            ...
                                            while ($row = mysqli_fetch_array($query)) {
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" class="form-control" readonly="true" value="<?php echo htmlentities($row['DEALER_EMAIL']); ?>" id="exampleInputEmail1" name="gmail" required="">

...
$query=mysqli_query($con,"select PRODUCT_NAME,PRODUCT_IMAGE3 from dealer_products where PRODUCT_ID='$pid'");
$cnt=1;
...
?>
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['PRODUCT_IMAGE3']);?>" width="200" height="100">
                                                </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
